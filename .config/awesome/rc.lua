...
local function set_wallpaper(s)
    ...
    if beautiful.wallpaper then
        ...
        gears.wallpaper.maximized("/home/shoaib/Downloads/porns/deepForest.jpeg", s, true)
    end
end
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey },            "f",     function () awful.util.spawn("rofi -show") end,
    ...
    awful.key({ modkey },            "q",     function () awful.util.spawn("scrot") end,
          {description = "run firefox", group = "launcher"}),
